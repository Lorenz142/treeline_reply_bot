...
# Schedule: 8am EST (12:00 UTC) to 8pm MT (02:00 UTC next day)
SCAN_START_UTC = 12
SCAN_END_UTC = 2
...
def is_within_schedule():
    """Check if current time is between 8am EST and 8pm MT."""
    hour = datetime.now(timezone.utc).hour
    # Window: 12:00 UTC to 02:00 UTC (next day)
    if SCAN_START_UTC > SCAN_END_UTC:
        return hour >= SCAN_START_UTC or hour < SCAN_END_UTC
    else:
        return SCAN_START_UTC <= hour < SCAN_END_UTC
